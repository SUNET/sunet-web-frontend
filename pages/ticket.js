		...
		return (
			<Layout {...this.props}>
              ...
              <p className="ticket-creation">
                <span	dangerouslySetInnerHTML={{ __html: `Created by ${ticket.fields.creator.displayName} &lt;${ticket.fields.creator.emailAddress}&gt; on ${new Date(ticket.fields.created).toLocaleString()}` }} />
              </p>
